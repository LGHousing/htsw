...
const actionMappingsPath = path.resolve(
    repoRoot,
    "src/housingSync/fields/actionMappings.ts"
);
const outputPath = path.resolve(repoRoot, "generated/actionMappings.scaffold.ts");
...
function guessKind(fieldName: string, typeText: string): string {
    ...
    if (fieldName === "conditions" || normalized.includes("Condition[]")) {
...
function parseExistingActionMappingLoreFields(source: string): ExistingLoreFields {
