...
const outputPath = path.resolve(repoRoot, "generated/conditionMappings.scaffold.ts");
...
function renderMappingEntry(def: ConditionTypeDef): string {
    ...
    return [
        `    ${def.type}: {`,
        `        displayName: CONDITION_NAMES.${def.type},`,
        `        loreFields: {`,
