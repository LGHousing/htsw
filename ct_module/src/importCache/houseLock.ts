 ...
 * changes only the name, so the old baseline still holds and the next import
 * diffs instead of rewriting. Refuses when the destination is already recorded,
 * which would merge two baselines.
 */
