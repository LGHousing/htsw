...
/**
 * Pairs up what one save removed with what it added, only when exactly one
 * identity of a type is gone and exactly one is new. Two of each can't be paired
 * from names alone.
 */
 ...
 * diffs instead of writing from scratch. An unconfirmed rename is reported, not
 * recorded, leaving the old name for the normal prune to remove.
 */
